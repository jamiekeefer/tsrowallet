...
This document describes the process of how tsrowallet developers must make
...
- The gRPC `protoc` plugin for Go
  ...
  tsrowallet `vendor` repo to avoid incompatibilities between generated code and
