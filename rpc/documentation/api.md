...
dynamically start the thesauro RPC client.  This RPC client is used for wallet
...
- `string network_address`: The host/IP and optional port of the RPC server to
  ...
  default port is chosen corresponding to the default thesauro RPC port of the
...
notifications passed from the JSON RPC of thesauro. Right now, wallet block processing
