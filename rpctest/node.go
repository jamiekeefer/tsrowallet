...
import (
	...
	"github.com/jamiekeefer/thesauro/certgen"
	rpc "github.com/jamiekeefer/thesauro/rpcclient"
	"github.com/jamiekeefer/thesauro/wire"
)

// nodeConfig contains all the args, and data required to launch a thesauro process
...
// command returns the exec.Cmd which will be used to start the thesauro process.
...
// to connect to the thesauro process that is launched via Start().
...
// as the base for the log and data directories for thesauro.
...
// Start creates a new thesauro process, and writes its pid in a file reserved for
...
// Stop interrupts the running thesauro process, and waits until it exits properly.
