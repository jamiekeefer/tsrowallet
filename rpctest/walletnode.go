...
// walletTestConfig contains all the args, and data required to launch a tsrowallet process
...
// command returns the exec.Cmd which will be used to start the tsrowallet
// process.
...
// to connect to the tsrowallet process that is launched via Start().
...
// process, and as the base for the log and data directories for tsrowallet.
...
// Start creates a new tsrowallet process, and writes its pid in a file reserved
...
// Stop interrupts the running tsrowalletTest process process, and waits until it exits
