...
// processes to communicate with and and manage the lifetime of a thesauro child
...
// message, shutdown begins.  This prevents thesauro from continuing to run
...
// for a child thesauro process to communicate with a parent process without the
